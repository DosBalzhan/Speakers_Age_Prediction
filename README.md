Abstract—In this report, we present a methodology for estimating the age of a speaker based on their speech characteristics. Our approach integrates feature engineering, including the analysis of
